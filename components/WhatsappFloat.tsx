  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-2 group">
      ...
      <a
        ...
        className="w-14 h-14 bg-[#25D366] text-white rounded-full flex items-center justify-center shadow-lg shadow-[#25d366]/30 hover:scale-110 active:scale-95 transition-all duration-300"
        aria-label="Contacter ETS sur WhatsApp"
      >
