...
export default function TranslationCert() {
  const documentTypes = [
    {
      title: "Actes d'état civil",
      desc: "Naissance, mariage, décès, divorce",
      icon: FileText,
    },
    {
      title: "Documents d'identité",
      desc: "CNI, passeport, casier judiciaire, attestation de résidence",
      icon: Fingerprint,
    },
    {
      title: "Documents académiques",
      desc: "Diplômes, relevés de notes, certificat de scolarité",
      icon: GraduationCap,
    },
    {
      title: "Documents d'entreprise",
      desc: "Déclaration fiscale, registre de commerce (RCCM), bilans comptables, attestation de travail",
      icon: Building2,
    },
    {
      title: "Documents financiers",
      desc: "Relevés bancaires, fiches de paie, attestation de revenus",
      icon: Landmark,
    },
    {
      title: "Documents médicaux",
      desc: "Assurances, visites médicales, certificats médicaux, ordonnances, arrêt maladie",
      icon: HeartPulse,
    },
    {
      title: "Documents juridiques",
      desc: "Contrats commerciaux, statuts de société, accord de confidentialité, jugements, actes notariés",
      icon: FileSignature,
      fullWidth: true,
    },
  ];
  ...
  return (
    <section id="translation" className="relative py-20 bg-navy text-white overflow-hidden">
      {/* Top ribbon border with primary color brand gradient */}
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <p className="text-sm sm:text-base text-gray-300">
            Vos documents officiels traduits par des traducteurs assermentés. Validité garantie auprès des administrations, ministères, ambassades et universités.
          </p>
        </div>
        ...
        <div className="bg-brand-green rounded-3xl p-8 sm:p-10 flex flex-col md:flex-row items-center justify-between gap-6 shadow-xl shadow-brand-green/10">
          <div className="flex items-center gap-4 text-left max-md:flex-col max-md:text-center">
            ...
            <div>
              <p className="text-lg sm:text-xl font-bold text-white leading-tight">
                Obtenez votre devis de traduction
              </p>
              <p className="text-xs sm:text-sm text-white/90 font-medium mt-1">
                Réponse rapide · Confidentialité et rigueur académique absolues
              </p>
            </div>
          </div>
          <a
          ...
          >
            {/* Minimalist modern WhatsApp SVG vector */}
